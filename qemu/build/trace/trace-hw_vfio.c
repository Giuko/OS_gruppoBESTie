...
uint16_t _TRACE_VFIO_RESET_HANDLER_DSTATE;
...
TraceEvent _TRACE_VFIO_RESET_HANDLER_EVENT = {
    .id = 0,
    .name = "vfio_reset_handler",
    .sstate = TRACE_VFIO_RESET_HANDLER_ENABLED,
    .dstate = &_TRACE_VFIO_RESET_HANDLER_DSTATE 
};
...
TraceEvent *hw_vfio_trace_events[] = {
    ...
    &_TRACE_VFIO_RESET_HANDLER_EVENT,

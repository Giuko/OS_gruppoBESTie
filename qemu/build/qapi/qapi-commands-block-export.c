...
void qmp_marshal_nbd_server_start(QDict *args, QObject **ret, Error **errp)
{
    ...
    qmp_nbd_server_start(arg.addr, arg.has_handshake_max_seconds, arg.handshake_max_seconds, arg.tls_creds, arg.tls_authz, arg.has_max_connections, arg.max_connections, &err);
    if (err) {
